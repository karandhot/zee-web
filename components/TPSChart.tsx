  ...
  return (
    <div className="w-full h-96 bg-slate-900/50 backdrop-blur-xl rounded-3xl p-6 border border-slate-800 shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h3 className="text-xl font-bold text-white">Live Network Throughput</h3>
          <p className="text-slate-400 text-sm">Real-time JoyboyVM execution metrics</p>
        </div>
        <div className="text-right">
          <div className="text-3xl font-black text-cyan-400 animate-pulse">
            {(data[data.length - 1]?.tps / 1000).toFixed(1)}k <span className="text-xs uppercase">TPS</span>
          </div>
